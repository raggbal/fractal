...
(function () {
    ...
    function ensureStyle() {
        ...
        style.textContent = [
            ...
            '  color: var(--fr-color-text-muted, var(--vscode-descriptionForeground, #777));',
            '  border-bottom: 1px solid var(--fr-color-border, var(--vscode-panel-border, #ddd)); }',
            '.viewer-side-panel-title { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }',
            '.viewer-side-panel-close { background: transparent; border: none; cursor: pointer;',
            '  font-size: 16px; opacity: 0.6; padding: 0 4px; color: inherit; }',
            '.viewer-side-panel-close:hover { opacity: 1; }',
