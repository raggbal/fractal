...
var Outliner = (function() {
    ...
    //   'hierarchical' (default): 既存の .outliner-children ネスト DOM (既存挙動完全保持)
    //   'flat': 全 row が同階層に並ぶ flat DOM (table mode 統合のための準備)
    // Phase F1.x で 'flat' 実装を段階追加、F1.5 で hierarchical 削除して flat 単一化予定。
    var RENDER_MODE = 'hierarchical';
